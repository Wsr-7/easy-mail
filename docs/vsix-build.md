...
```powershell
rtk powershell -NoProfile -Command "cd 'F:/otherProjects/codex/easy-mail/vscode-extension'; npm install"
rtk powershell -NoProfile -Command "cd 'F:/otherProjects/codex/easy-mail/vscode-extension'; npx @vscode/vsce package"
```

如果不希望临时使用 `npx`，也可以安装为 dev dependency：

```powershell
rtk powershell -NoProfile -Command "cd 'F:/otherProjects/codex/easy-mail/vscode-extension'; npm install --save-dev @vscode/vsce"
rtk powershell -NoProfile -Command "cd 'F:/otherProjects/codex/easy-mail/vscode-extension'; npm run package"
```
